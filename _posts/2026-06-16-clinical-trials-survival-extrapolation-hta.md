...
tags: [醫療科技評估, 臨床試驗, 藥物經濟學, 證據評質, 知識管理]
publish: true
syndicate: []
excerpt: "醫療科技評估人才培訓第二天深度解析：破解次族群分析陷阱、存活曲線外推迷思，建立批判性證據評讀能力。"
description: "醫療科技評估專業培訓課程揭露臨床試驗常見統計陷阱：次族群分析誤用、存活曲線外推風險。學習如何評估療效驗證、比較品選擇與長期成本效益預測，掌握健保給付決策的科學依據。"
description_en: "HTA expert training reveals critical pitfalls in clinical trial statistics: subgroup analysis misuse and survival extrapolation risks. Learn evidence evaluation, comparator selection, and long-term cost-effectiveness assessment for informed reimbursement decisions."
---
