...
tags: [HTA, 醫療政策, 醫療經濟學, 藥物評估]
publish: true
syndicate: []
excerpt: "GLP-1藥物不只是減重神藥，更是抗發炎代謝藥物。面對50億澳幣的預算衝擊與健保給付困境，如何在臨床療效、經濟成本與政策公平間取得平衡？"
description: "GLP-1（如Wegovy、Mounjaro）從臨床、經濟與政策角度深度分析。本文探討其作為抗發炎代謝藥物的療效、預算衝擊與健保給付挑戰，揭示真實世界中的停藥困境與未來醫療科技評估的關鍵問題。"
description_en: "Deep analysis of GLP-1 drugs (Wegovy, Mounjaro) from clinical, economic, and policy perspectives. Explore their anti-inflammatory metabolic effects, budget impact, reimbursement challenges, and the critical role of health technology assessment in balancing innovation with sustainability."
---
