...
tags: ["醫療科技評估", "AI治理", "工作流程優化", "數位化轉型", "Health Technology Assessment", "AI Implementation", "Healthcare Digitalization"]
publish: true
syndicate: [linkedin]
excerpt: "作為基層HTA研究員，面對AI狂潮時感到既近又遠。不是AI不重要，而是缺乏自下而上的實作規劃與受控的內部環境。"
description: "HTA研究員親述AI落地困境：在缺乏完善數位基礎與自下而上實作規劃的現況下，如何在42天內完成高品質報告？探討AI真正落地需要的不是雲端空談，而是接地氣的工作流程解構與安全試錯空間。"
description_en: "An HTA researcher reveals the gap between AI hype and reality: without proper digitalization and bottom-up implementation plans, how can quality work be achieved under pressure? Discover why AI implementation needs practical workflow redesign, not just cloud-level policy discussions."
---
